...
fcfg --input=cert.conf.in --output=$DIR/root-a.conf --configs=site.yml -v=FileName:root-a -v=Suffix:'ROOT A' \
...
fcfg --input=cert.conf.in --output=$DIR/root-b.conf --configs=site.yml -v=FileName:root-b -v=Suffix:'ROOT B' \
...
fcfg --input=cert.conf.in --output=$DIR/cross-a.conf --configs=site.yml -v=FileName:cross-a -v=Suffix:'CROSS ROOT A' \
...
fcfg --input=cert.conf.in --output=$DIR/cross-b.conf --configs=site.yml -v=FileName:cross-b -v=Suffix:'CROSS ROOT B' \
